    ...
    public partial class frmAddEmployee : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (ValidateChildren(ValidationConstraints.Enabled))
            {
                ...
                //var data = Encoding.ASCII.GetBytes(txtPassword.Text);
                ae.Password = en.encrypt(txtPassword.Text);
                ...
                ae.Photo = path+ "\\empImages\\" + ae.Nid + fileExt;
                if (ae.Photo == null)
                {
                ...
                //cmd.CommandText = "INSERT INTO tbl_employee VALUES ('" + ae.Name + "' ,'" + ae.FatherName + "' ,'" + ae.Dob + "' ,'" + ae.Gender + "' ,'" + ae.Email + "' ,'" + ae.Address + "' ,'" + ae.City + "' ,'" + ae.Country + "' ,'" + ae.Nid + "' ,'" + ae.Photo + "' ," + ae.DeptId + " ," + ae.DesigId + " ,'" + ae.JoinDate + "' ,'" + ae.JoinSalary + "' ,'" + ae.Username + "' ,'" + ae.Password + "' ,'" + ae.BankAccName + "' ,'" + ae.BankAccNumber + "' ,'" + ae.BankName + "' ,'" + ae.BankBranch + "')";
                ...
                cmd.Parameters.Add("@username",SqlDbType.VarChar,20).Value=ae.Username;
                cmd.Parameters.Add("@password",SqlDbType.VarChar,50).Value=ae.Password;
                ...
                System.IO.File.Copy(openFileDialog1.FileName, ae.Photo);
        ...
        private void txtUsername_Validating(object sender, CancelEventArgs e)
        {
            ...
            else
            {
                if (txtUsername.Text.Length > 5)
                {
                    ...
                    SqlCommand cmd = new SqlCommand();
                    cmd.Connection = Connection.conn;
                    cmd.CommandText = "SELECT COUNT(*) FROM tbl_employee WHERE username='" + txtUsername.Text + "'";
                    SqlDataAdapter adpt = new SqlDataAdapter(cmd);
                    DataTable dt = new DataTable();
                    adpt.Fill(dt);
                    if (dt.Rows[0][0].ToString() == "1")
                    {
                        e.Cancel = true;
                        errProvider.SetError(txtUsername, "Please choose a unique username!");
                    }
                    else 
                    {
                        e.Cancel = false;
                ...
                {
                    e.Cancel = true;
                    errProvider.SetError(txtUsername, "Username can't be less than 6 characters long.");
                }
        ...
        private void txtPassword_Validating(object sender, CancelEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    e.Cancel = true;
                    errProvider.SetError(txtPassword, "Please enter at least 8 character length password.");
                }
        ...
        private void ClearAll()
        {
            ...
            txtNid.Clear();
            picEmpProfile.Image = new Bitmap(path + "\\empImages\\placeholder-profile.png");
            cmbDesignation.Text = "";
            cmbDepartment.Text = "";
            txtJoinDate.Text = "";
            txtJoinSalary.Clear();
