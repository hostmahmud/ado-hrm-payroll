...
namespace HRM.Views
{
    public partial class frmDepartment : Form
    {
            ...
            if (ValidateChildren(ValidationConstraints.Enabled))
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    try
                    {
                        ...
                        {
                            cmd.CommandText = "update tbl_department set name=@name, status=@status where id=@id";
                            btnSave.Text = "Save";
                        }
                        else
                        {
                            cmd.CommandText = "INSERT INTO tbl_department VALUES(@name,@status)";
                        }
        ...
        private void showData() 
        {
            ...
            {
                List<AddDepartment> _dept = new List<AddDepartment>();
